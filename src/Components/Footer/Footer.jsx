    ...
    return (
        <>
            <div className="w-full h-screen flex p-[2vw] bg-[#f1f1f1]">
                <div className="leftSide w-1/2 h-full flex flex-col justify-between">
                    <div className="heading font-['Test_Founders_Grotesk_X_Condensed'] ">
                        {["EYE-", "OPENING"].map((heading, index) => (
                            <h1 className="text-[9vw] text-[#212121] leading-none -mb-[2vw] tracking-tight" key={index}>{heading}</h1>
                        ))}
                    </div>
                    <div className="svg">
                ...
                <div className="w-1/2 h-full flex flex-col justify-between gap-[4vw]">
                    <div className="heading font-['Test_Founders_Grotesk_X_Condensed'] ">
                        <h1 className="text-[9vw] text-[#212121] leading-none -mb-[2vw] tracking-tight">PRESENTATIONS</h1>
                    </div>
                    <div className="links font-['Neue_Montreal'] flex gap-[10vw]">
                        <div className="s flex flex-col gap-[1vw]">
                            <h4 className="font-bold">S:</h4>
                            <div className="flex flex-col gap-[0.2vw] w-fit">
                                {["Instagram", "Facebook", "Linkedin"].map((link, index) => (
                                    <a className="transition duration-300 ease-in hover:font-bold hover:underline" href="#" key={index}>{link}</a>
                                ))}
                            </div>
                        </div>
                        <div className="m flex flex-col gap-[1vw]">
